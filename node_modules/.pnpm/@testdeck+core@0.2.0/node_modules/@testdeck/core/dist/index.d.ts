 ...
 */
export declare type FrameworkContext = any;
export declare type Done = (err?: any) => void;
export declare type SuiteCallback = (this: FrameworkContext) => void;
export declare type CallbackOptionallyAsync = (this: FrameworkContext, done?: Done) => void | Promise<void>;
 ...
 */
export declare type ExecutionOptionDecorator = (value: number) => ClassDecorator & MethodDecorator;
/**
